...
public class EventsDao {
	...
	public List<Adiacenza> getArchi(String categoria, int mese){
		String sql="SELECT e1.offense_type_id as v1, e2.offense_type_id as v2, COUNT(DISTINCT e1.neighborhood_id) AS cnt "
		...
		try {
			...
			while(res.next()) {
				archi.add(new Adiacenza(res.getString("v1"),res.getString("v2"), res.getInt("cnt")));
			}
